...
<script src="/assets/plugin/jquery/jquery.min.js?ver=<?=JS_VER ?>"></script><!-- jQuery -->
<script src="/assets/plugin/jquery-ui/jquery-ui.min.js?ver=<?=JS_VER ?>"></script><!-- jQuery UI 1.11.4 -->
<script>$.widget.bridge('uibutton', $.ui.button)</script><!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->

<script src="/assets/plugin/bootstrap/js/bootstrap.bundle.min.js?ver=<?=JS_VER ?>"></script><!-- Bootstrap 4 -->
<script src="/assets/plugin/chart.js/Chart.min.js?ver=<?=JS_VER ?>"></script><!-- ChartJS -->
<script src="/assets/plugin/sparklines/sparkline.js?ver=<?=JS_VER ?>"></script><!-- Sparkline -->
<script src="/assets/plugin/jqvmap/jquery.vmap.min.js?ver=<?=JS_VER ?>"></script><!-- JQVMap -->
